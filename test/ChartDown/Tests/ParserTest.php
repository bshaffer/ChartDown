...
class ChartDown_Tests_ParserTest extends PHPUnit_Framework_TestCase
{
  ...
  public function testParseTokenStream()
  {
    ...
    $stream = new ChartDown_TokenStream(array(
      ...
      new ChartDown_Token(ChartDown_Token::LINE_START, ChartDown_Token::TEXT_TYPE, -1),
      new ChartDown_Token(ChartDown_Token::TEXT_TYPE, 'That old dusty wind', -1),
      new ChartDown_Token(ChartDown_Token::BAR_LINE, null, -1),
      new ChartDown_Token(ChartDown_Token::TEXT_TYPE, 'Blows through my bones', -1),
      new ChartDown_Token(ChartDown_Token::BAR_LINE, null, -1),
      new ChartDown_Token(ChartDown_Token::TEXT_TYPE, 'My whole life changed', -1),
      new ChartDown_Token(ChartDown_Token::BAR_LINE, null, -1),
      new ChartDown_Token(ChartDown_Token::TEXT_TYPE, 'When we were attacked by those clones', -1),
      new ChartDown_Token(ChartDown_Token::LINE_END, null, -1),
