 ...
 * @version    SVN: $Id: //depot/genesis_web/branches/falkland/bin/lib/vendor/symfony/lib/templating/sfTemplateEngine.php#2 $
 */
class sfTemplateEngine
{
  protected
    $loader    = null,
    $renderers = array(),
   ...
   */
  public function __construct(sfTemplateLoaderInterface $loader, array $renderers = array(), sfTemplateHelperSet $helperSet = null)
  {
    $this->loader    = $loader;
    $this->renderers = $renderers;

    $this->setHelperSet(null === $helperSet ? new sfTemplateHelperSet() : $helperSet);

    if (!isset($this->renderers['php']))
    {
      $this->renderers['php'] = new sfTemplateRendererPhp();
    }
   ...
   * @param sfTemplateHelperInterface $value The helper value
   */
  public function setHelperSet(sfTemplateHelperSet $helperSet)
  {
