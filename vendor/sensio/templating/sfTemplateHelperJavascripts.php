 ...
 * @version    SVN: $Id: //depot/genesis_web/branches/falkland/bin/lib/vendor/symfony/lib/templating/sfTemplateHelperJavascripts.php#2 $
 */
class sfTemplateHelperJavascripts extends sfTemplateHelper
{
  protected
    $javascripts = array();
